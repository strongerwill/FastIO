...
void free_pgd_page(unsigned long addr)
{
    ...
    { 
    	...
    	//if((pgd_used_counter/pgd_free_counter < 2) && ((pgd_used_counter + pgd_free_counter) >= 12))
...
void free_pmd_page(unsigned long addr)
{
	...
	//if((pmd_free_counter/pmd_used_counter>=3) && ((pmd_used_counter + pmd_free_counter) >= 1800))
    	...
    	//if((pmd_used_counter/pmd_free_counter < 2) && ((pmd_used_counter + pmd_free_counter) >= 48))
...
void free_pte_page(struct page *pte)
{
    ...
    { 
    	...
    	//if((pte_used_counter/pte_free_counter < 2) && (pte_used_counter >= 560))
