...
extern long
do_pgd_op(
    XEN_GUEST_HANDLE(ptrpgd_t)gptrpg, unsigned int count);

/* do_pmd_op */
extern long
do_pmd_op(
    XEN_GUEST_HANDLE(ptrpmd_t)gptrpg, unsigned int count);

/* do_pte_op */
extern long
do_pte_op(
    XEN_GUEST_HANDLE(ptrpte_t)gptrpg, unsigned int count);
//extern long
//do_pgtable_op(
//    unsigned long ker_pfn, unsigned long va, unsigned int flag);
