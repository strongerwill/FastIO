...
When the allocation function is invoked, it first searches the blocks of pages of the requested size following the chain.
If no blocks of the requested size are free, the allocator will blocks of the next size (which is twice that of the requested size) are looked for.
