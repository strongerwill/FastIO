...
The Buddy allocator~\cite{buddyallocator} manages all free pages that are managed in blocks as powers of 2.
...
This process continues until all of the free areas have been searched or until a block has been found.
