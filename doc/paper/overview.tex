...
At runtime, the \cache responses the page table allocation and deallocation requests.
...
\subsection{\module and Fine-Grained Validation}\label{sec:fine-grained}
