...
\mypara{Frequency of IOTLB Flushes}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        ...
        \caption{Execution time of L1 allocation.}
        \label{fig:subfig:a}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.5\textwidth}
        ...
        \caption{Execution time of L1 deallocation.}
        \label{fig:subfig:b}
    \end{subfigure}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        ...
        \caption{Execution time of L2 allocation.}
        \label{fig:subfig:a}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.5\textwidth}
        ...
        \caption{Execution time of L2 deallocation.}
        \label{fig:subfig:b}
    \end{subfigure}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        ...
        \caption{Execution time of L3 allocation.}
        \label{fig:subfig:a}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.5\textwidth}
        ...
        \caption{Execution time of L3 deallocation.}
        \label{fig:subfig:b}
    \end{subfigure}
