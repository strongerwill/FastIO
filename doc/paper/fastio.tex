...
The other one is the the additional dependence between the page table (de)allocations and the IOTLB flushes, which inevitably introduces extra IOTLB misses, and may consequently introduce negatively impacts on the I/O performance of all peripheral devices.
...
The micro experiment results indicate that \name is able to effectively eliminates the additional IOTLB flushes, and reduces (de)allocation time of the page table by xx\% on average. 
