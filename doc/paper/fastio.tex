...
First, such security patches exacerbate the problem that the execution paths of the guest page table (de)allocation become extremely long, which would consequently increase the latencies of the processes' creations and exits.
...
The macro benchmarks show that the latencies of the process creations and exits are expectedly reduced by xx\% on average respectively.
