...
Second, \name eliminates the additional IOTLB misses with a fine-grained validation scheme, which performs software and DMA validations separately, instead of doing both together as before.
