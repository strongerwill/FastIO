...
The micro experiment results indicate that \name is able to \emph{completely eliminates} the additional IOTLB flushes in the most of the time, and effectively reduces (de)allocation time of the page table by xx\% on average. 
...
Moreover, the \emph{SPECINT} and \emph{netperf} results indicate that \name has \emph{no} negative impacts on CPU computation and network I/O.% and disk I/O. 
\end{abstract}
