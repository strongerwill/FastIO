...
In addition, Xen also requires that every page type update only occur between writable and non-writable pages, as summaried in Figure~\ref{fig:page-type-updates}.
...
To achieve a better I/O performance, the DMA remapping should avoid taking the page-table path frequently.
